...
class AssignedLabsListView(DoctorRequiredMixin, ListView):
    model = AssignedLabs
...
class AssignedLabsDetailView(DoctorRequiredMixin, DetailView):
    model = AssignedLabs
...
class AssignedLabsCreateView(DoctorRequiredMixin, CreateView):
    model = AssignedLabs
...
class AssignedLabsUpdateView(DoctorRequiredMixin, UpdateView):
    model = AssignedLabs
    form_class = AssignedLabsForm
    template_name = 'sanatorium/doctors/prescriptions/labs/assigned_labs_form.html'
    context_object_name = 'assigned_lab'
...
class AssignedLabsDeleteView(DoctorRequiredMixin, DeleteView):
    model = AssignedLabs
    context_object_name = 'assigned_lab'
