...
class FinalAppointmentEnhancedDeleteView(DoctorRequiredMixin, DeleteView):
    ...
    def get_success_url(self):
        # Redirect to the illness history detail page after deletion
        return reverse_lazy('illness_history_detail', kwargs={'pk': self.object.illness_history.pk})

    def delete(self, request, *args, **kwargs):
        messages.success(request, 'Заключительный прием успешно удален')
